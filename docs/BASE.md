...
- **Docker:** Multi-stage **`Dockerfile`** + **`docker-compose.yml`** at repo root; CI runs **`docker build`** after tests ([docker.md](./docker.md)).
